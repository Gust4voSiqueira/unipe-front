    ...
    return (
        <>
            ...
            <div className='uberona-warning-container'>
                ...
                <p className='uberona-warning-text'>Esta funcionalidade foi desenvolvida por alunos; portanto, tome todas as precauções ao aceitar qualquer carona.</p>
                ...
                <div className='uberona-warning-buttons-container'>
                    ...
                    <button className='uberona-warning-button button-green' onClick={() => navigate("/passenger")}>
